...
#define detSymMat(mat)                                                                                                 \
    ({                                                                                                                 \
        double mkVar(_detMat, t1) = mat[spaceIdx2voigt(0, 0)] * mat[spaceIdx2voigt(1, 1)] * mat[spaceIdx2voigt(2, 2)]; \
        double mkVar(_detMat, t2) = mat[spaceIdx2voigt(0, 0)] * mat[spaceIdx2voigt(1, 2)] * mat[spaceIdx2voigt(1, 2)]; \
        double mkVar(_detMat, t3) = mat[spaceIdx2voigt(1, 1)] * mat[spaceIdx2voigt(0, 2)] * mat[spaceIdx2voigt(0, 2)]; \
        double mkVar(_detMat, t4) = mat[spaceIdx2voigt(2, 2)] * mat[spaceIdx2voigt(0, 1)] * mat[spaceIdx2voigt(0, 1)]; \
        double mkVar(_detMat, t5) = mat[spaceIdx2voigt(1, 2)] * mat[spaceIdx2voigt(0, 2)] * mat[spaceIdx2voigt(0, 1)]; \
        mkVar(_detMat, t1) - mkVar(_detMat, t2) - mkVar(_detMat, t3) - mkVar(_detMat, t4) + 2.0 * mkVar(_detMat, t5);  \
    })
#define invSymMat(imat, mat, det)                                                                                                                          \
    {                                                                                                                                                      \
        double mkVar(invMat, t0) = (mat[spaceIdx2voigt(1, 1)] * mat[spaceIdx2voigt(2, 2)] - mat[spaceIdx2voigt(1, 2)] * mat[spaceIdx2voigt(1, 2)]) / det;  \
        double mkVar(invMat, t1) = (mat[spaceIdx2voigt(0, 0)] * mat[spaceIdx2voigt(2, 2)] - mat[spaceIdx2voigt(0, 2)] * mat[spaceIdx2voigt(0, 2)]) / det;  \
        double mkVar(invMat, t2) = (mat[spaceIdx2voigt(0, 0)] * mat[spaceIdx2voigt(1, 1)] - mat[spaceIdx2voigt(0, 1)] * mat[spaceIdx2voigt(0, 1)]) / det;  \
        double mkVar(invMat, t3) = (-mat[spaceIdx2voigt(0, 0)] * mat[spaceIdx2voigt(1, 2)] + mat[spaceIdx2voigt(0, 2)] * mat[spaceIdx2voigt(0, 1)]) / det; \
        double mkVar(invMat, t4) = (-mat[spaceIdx2voigt(1, 1)] * mat[spaceIdx2voigt(0, 2)] + mat[spaceIdx2voigt(1, 2)] * mat[spaceIdx2voigt(0, 1)]) / det; \
        double mkVar(invMat, t5) = (mat[spaceIdx2voigt(1, 2)] * mat[spaceIdx2voigt(0, 2)] - mat[spaceIdx2voigt(2, 2)] * mat[spaceIdx2voigt(0, 1)]) / det;  \
        imat[spaceIdx2voigt(0, 0)] = mkVar(invMat, t0);                                                                                                    \
        imat[spaceIdx2voigt(1, 1)] = mkVar(invMat, t1);                                                                                                    \
        imat[spaceIdx2voigt(2, 2)] = mkVar(invMat, t2);                                                                                                    \
        imat[spaceIdx2voigt(1, 2)] = mkVar(invMat, t3);                                                                                                    \
        imat[spaceIdx2voigt(0, 2)] = mkVar(invMat, t4);                                                                                                    \
        imat[spaceIdx2voigt(0, 1)] = mkVar(invMat, t5);                                                                                                    \
    }

#define symMatMulVec(mVec, symMat, vec)                                                                                                                \
    {                                                                                                                                                  \
        double mkVar(mMv, v0) = symMat[spaceIdx2voigt(0, 0)] * vec[0] + symMat[spaceIdx2voigt(0, 1)] * vec[1] + symMat[spaceIdx2voigt(0, 2)] * vec[2]; \
        double mkVar(mMv, v1) = symMat[spaceIdx2voigt(0, 1)] * vec[0] + symMat[spaceIdx2voigt(1, 1)] * vec[1] + symMat[spaceIdx2voigt(1, 2)] * vec[2]; \
        double mkVar(mMv, v2) = symMat[spaceIdx2voigt(0, 2)] * vec[0] + symMat[spaceIdx2voigt(1, 2)] * vec[1] + symMat[spaceIdx2voigt(2, 2)] * vec[2]; \
        mVec[0] = mkVar(mMv, v0);                                                                                                                      \
        mVec[1] = mkVar(mMv, v1);                                                                                                                      \
        mVec[2] = mkVar(mMv, v2);                                                                                                                      \
    }

#define symMatScaleAdd(c, a, s, b)                                                         \
    { /*>> c = a + s * b <<*/                                                              \
        c[spaceIdx2voigt(0, 0)] = a[spaceIdx2voigt(0, 0)] + (s) * b[spaceIdx2voigt(0, 0)]; \
        c[spaceIdx2voigt(1, 1)] = a[spaceIdx2voigt(1, 1)] + (s) * b[spaceIdx2voigt(1, 1)]; \
        c[spaceIdx2voigt(2, 2)] = a[spaceIdx2voigt(2, 2)] + (s) * b[spaceIdx2voigt(2, 2)]; \
        c[spaceIdx2voigt(1, 2)] = a[spaceIdx2voigt(1, 2)] + (s) * b[spaceIdx2voigt(1, 2)]; \
        c[spaceIdx2voigt(0, 2)] = a[spaceIdx2voigt(0, 2)] + (s) * b[spaceIdx2voigt(0, 2)]; \
        c[spaceIdx2voigt(0, 1)] = a[spaceIdx2voigt(0, 1)] + (s) * b[spaceIdx2voigt(0, 1)]; \
    }

#define symEye(a)                    \
    {                                \
        a[spaceIdx2voigt(0, 0)] = 1; \
        a[spaceIdx2voigt(1, 1)] = 1; \
        a[spaceIdx2voigt(2, 2)] = 1; \
        a[spaceIdx2voigt(1, 2)] = 0; \
        a[spaceIdx2voigt(0, 2)] = 0; \
        a[spaceIdx2voigt(0, 1)] = 0; \
    }
...
#define detSymMat(mat) (mat[spaceIdx2voigt(0,0) * mat[spaceIdx2voigt(1,1) - mat[spaceIdx2voigt(0,1) * mat[spaceIdx2voigt(0,1))
#define invSymMat(imat, mat, det)                                    \
    {                                                                \
        double mkVar(invMat, t0) = mat[spaceIdx2voigt(1, 1)] / det;  \
        double mkVar(invMat, t1) = mat[spaceIdx2voigt(0, 0)] / det;  \
        double mkVar(invMat, t5) = -mat[spaceIdx2voigt(0, 1)] / det; \
        imat[spaceIdx2voigt(0, 0)] = mkVar(invMat, t0);              \
        imat[spaceIdx2voigt(1, 1)] = mkVar(invMat, t1);              \
        imat[spaceIdx2voigt(0, 1)] = mkVar(invMat, t5);              \
    }
...
#define symMatMulVec(mVec, symMat, vec)                                                                        \
    {                                                                                                          \
        double mkVar(mMv, v0) = symMat[spaceIdx2voigt(0, 0)] * vec[0] + symMat[spaceIdx2voigt(0, 1)] * vec[1]; \
        double mkVar(mMv, v1) = symMat[spaceIdx2voigt(0, 1)] * vec[0] + symMat[spaceIdx2voigt(1, 1)] * vec[1]; \
        mVec[0] = mkVar(mMv, v0);                                                                              \
        mVec[1] = mkVar(mMv, v1);                                                                              \
    }
